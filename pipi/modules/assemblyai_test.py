...
load_dotenv("/home/babapi/calhacks/.env")
...
# Example usage: only runs when this script is executed directly, not on import
# if __name__ == "__main__":
#     audio = transcribe_audio('/home/babapi/calhacks/pipi/temp_storage/audio.wav')
#     print(audio)
